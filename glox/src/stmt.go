...
// Class      : Token name, List<StmtFunction> methods, List<StmtFunction> staticMethods, List<StmtFunction> getters
...
func NewStmtClass(name *Token, methods, staticMethods []*StmtFunction, getters []*StmtFunction) *StmtClass {
	return &StmtClass{
		name:          name,
		methods:       methods,
